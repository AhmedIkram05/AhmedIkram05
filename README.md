...
- **AI Engineering** - 3-layer anomaly detection at 0.92 held-out macro-F1 · agentic RAG gated by RAGAS · 3 QLoRA variants of Qwen3-14B promoted by a statistical gate (7.0× F2P) · Global LSTM forecasting with weekly Airflow retraining and statistically-gated promotion (StockLens)
