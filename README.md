...
- **AI Engineering** - 3-layer anomaly detection at 0.92 held-out macro-F1 (0.94 on a temporal holdout, 0.93 on a held-out second generator config) · agentic RAG gated by RAGAS · 3 QLoRA variants of Qwen3-14B promoted by a statistical champion/challenger gate (7.0× F2P), wrapped in a CLI model registry onboarding any open-weight HF model
